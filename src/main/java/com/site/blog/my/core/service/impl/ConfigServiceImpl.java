...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "Iceberg Blog";
    ...
    public static final String yourAvatar = "/admin/dist/img/gitHubOlder.jpg";
    public static final String yourEmail = "HoryChang@163.com";
    public static final String yourName = "Hory";
    ...
    public static final String footerCopyRight = "@2020 Hory";
    public static final String footerPoweredBy = "ICEBERG BLOG";
